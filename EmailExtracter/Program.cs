...
namespace AbbreviationsAndURLs
{
    class Program
    {
        static void Main(string[] args)
        {
//            string data = "www.onet.pl http://www.onet.pl https://www.onet.pl";
//            Replacer.ExtractUrl(data);


            string wiadomosc = "HI ADN AD normal word ADN WAYF WTH WKD";
            string nowaWiadomosc = Replacer.ReplaceAbbreviation(wiadomosc);

            Console.WriteLine(nowaWiadomosc);
        }
    }
